...
@section('title', 'PiiNews | Baca berita online')
      ...
      <div class="grid grid-cols-1 md:grid-cols-1 lg:grid-cols-12 gap-5">
        ...
        <div
          ...
          <a href="{{ route('news.show', $news[0]->slug) }}">
            ...
            <img src="{{ asset('storage/' . $news[0]->thumbnail )}}" alt="berita1" class="rounded-2xl" style="height: 150px; object-fit: cover;">
        ...
        <a href="{{ route('news.show', $new->slug) }}"
          ...
          <img src="{{ asset('storage/' . $new->thumbnail )}}" alt="berita2" class="rounded-xl w-full md:max-h-48">
